...
$\chi_{\max}$ versus $L$ (left) and $M(\Tc)$ versus $L$ (right), with
power-law fits yielding $\gamma/\nu = 1.933(30)$ and $\beta/\nu = 0.492(26)$.
Reweighting allows all sizes $L = 16$--$48$ to contribute to the fit with
properly resolved critical peaks.}
